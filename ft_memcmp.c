...
/*   Updated: 2022/10/26 16:20:27 by tbolkova         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief This function compares byte string "s1" against byte string "s2". Both strings are assumed to be "n" bytes long.
 * 
 * @param s1 String that we are comparing with.
 * @param s2 String that we are comparing against.
 * @param n Size of both strings.
 * @return This function returns "zero" if the two strings are identical, otherwise it returns the difference between the first two differing bytes (treated as unsigned char values).
